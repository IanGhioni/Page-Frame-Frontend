...
const BuscarContenido = () => {
   ...
   const fetchData = async () => {
      try {
         ...
         if (params.libro == "true") {
            ...
            res = await api.buscarPorNombreLibros(
               params.titulo,
               params.pagina,
               rows
            );
            ...
            res = await api.buscarPorNombrePeliculas(
               params.titulo,
               params.pagina,
               rows
            );
   ...
   const onPageChange = async (event) => {
      ...
      navigate(
         `/buscarContenido/${params.titulo}/${newPage}/${filtrarLibros}/${filtrarPelis}`
      );
      setLoading(false);
   };
   return (
               ...
               <div>
                  <div className="container-titulo">
                     <h2 className="buscador-titulo">
                        Resultados de buscar "{params.titulo}"
                     </h2>
